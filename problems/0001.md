...
<article class="grid grid-cols-2 gap-2 h-full">

<div id="problem" class="h-full">
...
.vp-page > [vp-content],
.vp-page > [vp-content] > div {
  @apply h-full p-2 w-full;
  max-width: 100%;
}

article > div {
  @apply overflow-y-auto p-4 rounded-xl;
